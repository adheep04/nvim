...
M.bases = {
  red       = '#d65867',  -- Warmer, less harsh red
  orange    = '#e8886b',  -- Already warm, keep it
  yellow    = '#e5c07b',  -- Golden yellow
  green     = '#a8c373',  -- Warm olive green
  blue      = '#6b9bd1',  -- Warmer, less electric blue
  purple    = '#8b7eb8',  -- Keep your purple identity
  grey      = '#4a4653',  -- Purple-tinted gray
  debug     = '#e87590',  -- Warm pink
}
--
-- M.bases = {
--   -- Meeting halfway between sharp and soft
--   red       = '#d75f68',  -- Between #CB4251 and #e88388
--   orange    = '#eb8d49',  -- Between #F37A2E and #e8a368
--   yellow    = '#f5c458',  -- Between #FFBE34 and #e5c07b
--   green     = '#a4ce62',  -- Between #AAD94C and #98c379
--   blue      = '#51a7f7',  -- Between #409FFF and #61afef
--   purple    = '#6b5caa',  -- Between #4C3889 and #9a7ecc
--   grey      = '#3d3842',  -- Between #292929 and #4b5263
--   debug     = '#ff7b8b',  -- Softer than pure magenta
-- }
...
local c = {
  ...
  bg_float  = M.shades.grey[-3],
  mg        = M.shades.grey[0],
  line      = '#141419',  -- Subtle but visible
  
  acc       = M.shades.blue[-1],
  
  -- Diagnostics - noticeable but not harsh
  ok        = M.shades.green[0],   -- Moved from [1] to [0]
  err       = M.shades.red[0],     
  info      = M.shades.blue[0],    
  warn      = M.shades.yellow[0],  
  hint      = M.shades.purple[0],  
  
  -- Dim backgrounds with more subtlety
  ok_dim    = M.shades.green[-4],
  err_dim   = M.shades.red[-4],
  info_dim  = M.shades.blue[-4],
  warn_dim  = M.shades.yellow[-4],
  ...
  -- Syntax - keeping character but refined
  comment   = M.shades.grey[1],
  func      = M.shades.yellow[0],
  constant  = M.shades.red[0],
  value     = M.shades.red[0],     -- Toned down from [1]
  type      = M.shades.blue[0],
  string    = M.shades.green[0],
  keyword   = M.shades.orange[0],
